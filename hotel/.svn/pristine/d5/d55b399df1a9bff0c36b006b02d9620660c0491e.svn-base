...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="resource/easyui/js/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="resource/easyui/js/themes/icon.css" />
    <script type="text/javascript" src="resource/easyui/js/jquery-1.4.2.min.js"></script>
    <script type="text/javascript" src="resource/easyui/js/jQuery.easyui.js"></script>

	<script type="text/javascript" src='resource/easyui/js/outlook2.js'> </script>

    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"顾客管理",
							"menus":[{"menuname":"菜单管理","icon":"icon-nav","url":"http://www.16sucai.com"},
									...
									{"menuname":"顾客住房情况","icon":"icon-log","url":"tohumanlist.do"}
								]
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; "><img src="resource/easyui/images/blocks.gif" width="20" height="20" align="absmiddle" /> 酒店后台</span>
    </div>
